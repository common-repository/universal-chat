...
//        'uwp_third_tab'  => 'Third Tab',
    ...
    private static $settings_sections = array(
        'section_one'   => array(
            'tab'         => 'uwp_first_tab',
            'title'       => 'Chat Setup',
            'description' => 'Paste the Html Widget code from Universal Chat here',
        ),
//        'section_two'   => array(
//            'tab'         => 'uwp_first_tab',
//            'title'       => 'Piwik Setup',
//            'description' => 'Connecting to the Piwik Server (for Analytics)',
//        ),
//        'section_three' => array(
//            'tab'         => 'uwp_layout_tab',
//            'title'       => 'Styles',
//            'description' => 'Control the look and feel of the chat window',
//        ),
        /*'section_four'  => array(
            'tab'         => 'uwp_second_tab',
            'title'       => 'Section #4',
    ...
    private static $plugin_settings = array(
      ...
      /* === Section One === */
        ...
        // array(
            // 'name'    => 'universal_telegram_account',
            // 'title'   => 'Telegram account',
            // 'section' => 'section_one',
            // 'field'   => array(
                // 'type'     => 'text',
                // 'description' => 'Fill it to connect to a specific account, or leave empty to be notified by the bot',
            // ),
            // 'default' => 'UniversalAgentBot',
        // ),
        // array(
            // 'name'    => 'universal_piwik_site_id',
            // 'title'   => 'Site Id',
            // 'section' => 'section_two',
            // 'field'   => array(
                // 'type'     => 'number',
        ...
        // ),
        // array(
            // 'name'    => 'universal_style_width',
            // 'title'   => 'Window width',
            // 'section' => 'section_three',
            // 'field'   => array(
                // 'type'     => 'text',
                // 'description' => 'Can be in % or px',
            // ),
            // 'default' => '350px',
        // ),
        // array(
            // 'name'    => 'universal_style_height',
            // 'title'   => 'Window height',
            // 'section' => 'section_three',
            // 'field'   => array(
                // 'type'     => 'number',
        ...
        // ),
        // array(
            // 'name'    => 'universal_style_button',
            // 'title'   => 'Button styles',
            // 'section' => 'section_three',
            // 'field'   => array(
                // 'type'     => 'textarea',
            // ),
            // 'default' => 'background-color: #208f7c; color: #fff; border-radius: 9px 9px 0px 0px; font: normal 15px sans-serif; height: 37px;',
        // ),
        /*array(
            'name'    => 'universal_wordpress_text_2',
        ...
        array(
            'name'    => 'universal_wordpress_dropdown_1',
        ...
        /* === Section Two ===
        array(
            'name'    => 'universal_wordpress_radio_1',
        ...
        array(
            'name'    => 'universal_wordpress_checkbox_1',
        ...
        array(
            'name'    => 'universal_wordpress_checkbox_2',
        ...
        array(
            'name'    => 'universal_wordpress_textarea_1',
...
Mauris lectus augue, mollis eget ultricies quis, gravida vitae mauris.
        ...
        array(
            'name'    => 'universal_wordpress_password_2',
        ...
        /* === Section Four ===
        array(
            'name'    => 'universal_wordpress_dropdown_2',
        ...
        array(
            'name'    => 'universal_wordpress_radio_2',
        ...
        /* === Section Five ===
        array(
            'name'    => 'universal_wordpress_colorpicker_1',
        ...
        array(
            'name'    => 'universal_wordpress_colorpicker_2',
        ...
        array(
            'name'    => 'universal_wordpress_colorpicker_3',
        ...
        /* === Section Six ===
        array(
            'name'    => 'universal_wordpress_text_upload_1',
        ...
        array(
            'name'    => 'universal_wordpress_html_1',
            'title'   => 'HTML Example',
            'section' => 'section_six',
            'field'   => array(
                'type'        => 'html',
